 ...
 * Question 1 - Logistic Regression on KKD dataset
 *
 * Group:
 * ------
 * desaijuhi
	 ...
	 */
  	public static void main(String[] args) 
  	{
		// Turn logging level down - we don't need all this noise
    		...
    		SparkConf sparkConf = new SparkConf().setAppName("QuestionOneLR");
		...
		// Save metrics to a file on hadoop
			...
			String outFileName = "target/results_q1lr.txt";
